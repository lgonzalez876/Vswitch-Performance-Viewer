            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, mkdirp(outputPath_1)];
                    case 4:
                        _f.sent();
                        _f.label = 5;
                    case 5:
                    ...
                    case 15:
                        ...
                        return [2 /*return*/, Promise.all(builderPromises).then(function () {
                                ...
                                return mkdirp(path.dirname(outputPath)).then(function () { return __awaiter(_this, void 0, void 0, function () {
                                    var buffer;
