...
var ExtensionBase = /** @class */ (function (_super) {
    ...
    ExtensionBase.prototype.getMergeSettings = function () {
        return Promise.all([
            ...
            this.commandArgs.manifestJs.val().then(function (files) { return files && files.length ? files[0] : null; }),
            ...
            var root = values[0], locRoot = values[1], manifestJs = values[2], env = values[3], manifests = values[4], manifestGlob = values[5], override = values[6], overridesFile = values[7], revVersion = values[8], bypassValidation = values[9], publisher = values[10], extensionId = values[11], json5 = values[12];
            if (publisher) {
